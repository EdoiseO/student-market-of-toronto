...
export default function MessageThreadLoading() {
  return (
    <main aria-busy="true" aria-label="Loading conversation" className="h-full min-h-0 overflow-hidden bg-white dark:bg-card md:bg-zinc-100 md:px-4 md:pb-4 md:pt-2 md:dark:bg-background lg:px-5 lg:pb-5 lg:pt-3">
