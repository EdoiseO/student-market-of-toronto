...
export function MessageThreadSkeleton() {
  return (
    <section
      aria-hidden="true"
      className="@container/thread flex min-h-0 max-w-full flex-1 touch-pan-y flex-col overflow-hidden overscroll-x-none border-y border-zinc-200 bg-white/95 dark:border-border dark:bg-card md:rounded-2xl md:border md:shadow-sm"
    >
      ...
      <div className="shrink-0 border-t border-zinc-200 bg-white/95 px-2 py-1.5 pb-[max(0.375rem,env(safe-area-inset-bottom))] dark:border-border dark:bg-card/95 md:px-3 md:py-2">
        <div className="mx-auto w-full max-w-5xl rounded-[1.1rem] border border-zinc-200 bg-zinc-50/70 p-1 dark:border-border dark:bg-muted/20">
