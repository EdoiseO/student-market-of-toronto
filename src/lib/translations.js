export const translations = {
  en: {
    ...
    mapAppChoiceDescription: "Choose your preferred map app. The best match for this device appears first.",
    mapPreferredForDevice: "Device default first",
  ...
  fr: {
    ...
    mapAppChoiceDescription:
      "Choisissez votre application de cartes. L'option la mieux adaptée à cet appareil apparaît en premier.",
    mapPreferredForDevice: "Option de l'appareil en premier",
