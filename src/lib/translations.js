export const translations = {
  en: {
    adminQueueBreadcrumb: "Moderation",
    adminListingPhotos: "Listing photos",
    adminListingOpenPhoto: "Open listing photo",
    adminReportContextLimited: "Reported message and up to two messages before and after it.",
    adminReportFullConversation: "Review full conversation",
    adminQueueResults: "results",
    adminQueueSearch: "Search",
    adminQueueFilters: "Filters",
    adminQueueFilterDescription: "Choose filters, then show your results.",
    adminQueueShowResults: "Show results",
    adminQueueClearFilters: "Clear filters",
    adminQueueCloseFilters: "Close filters",
    adminQueueReview: "Review",
    adminQueueRetry: "Try again",
    adminQueueContext: "Context and history",
    adminQueueBack: "Back to queue",
    ...
    openingMarketplace: "Opening marketplace…",
    continueToMarketplace: "Continue to marketplace",
    signInUnavailable: "We couldn’t sign you in right now. Please try again.",
    authLinkInvalid: "This sign-in link is invalid or expired. Sign in below or request a new email.",
    ...
    adminAnnouncementWorkerConfigured: "Worker configured",
    adminAnnouncementWorkerNeedsScheduler: "Automatic delivery not configured",
    adminAnnouncementRunWorker: "Process pending deliveries",
    adminAnnouncementWorkerDescription:
      "Automatic delivery needs setup. This button processes pending deliveries in batches; scheduled announcements need a pass after their scheduled time.",
    ...
    adminAnnouncementCategory_general: "General",
    adminAnnouncementCategory_maintenance: "Maintenance",
    adminAnnouncementCategory_safety: "Safety",
    adminAnnouncementCategory_policy: "Policy",
    adminAnnouncementCategory_moderation: "Moderation",
    adminAnnouncementPriority: "Priority",
    adminAnnouncementPriority_low: "Low",
    adminAnnouncementPriority_normal: "Normal",
    adminAnnouncementPriority_high: "High",
    adminAnnouncementPriority_urgent: "Urgent",
    adminAnnouncementAudience: "Audience",
    adminAnnouncementAudience_all: "Everyone",
    adminAnnouncementAudience_school: "Specific schools",
    adminAnnouncementAudience_role: "By role",
    adminAnnouncementAudience_selected: "Selected accounts",
    adminAnnouncementRole_member: "Members",
    adminAnnouncementRole_staff: "Staff",
    adminAnnouncementRole_moderator: "Moderators",
    adminAnnouncementRole_admin: "Administrators",
    ...
    adminAnnouncementSearchCompact: "Search titles",
    ...
    preparingResetSession: "Checking your reset link…",
    sendingResetLink: "Sending reset link…",
    updatingPassword: "Updating password…",
    recoveryForAccount: "Resetting the password for",
    recoverySessionNotice: "This changes only this account’s password. Another signed-in account stays signed in. Keep this page open until you finish.",
    recoveryPasswordPolicy: "Use at least 8 characters. Your account’s additional password requirements also apply.",
    recoveryLinkInvalid: "This link is expired, already used, or was requested in another browser. Request a new reset email here and open it in this browser.",
    recoveryPasswordRejected: "The password was not accepted. Request a new reset email and choose a different password that meets your account’s requirements.",
    recoveryUnavailable: "We couldn’t process the reset request right now. Please try again shortly.",
    recoveryOutcomeUnknown: "We couldn’t confirm the result. Try signing in with your new password. If it doesn’t work, request a new reset email.",
    recoveryCompleteTitle: "Password updated",
    recoveryComplete: "Your new password is ready. You can now sign in with it.",
    recoveryRevocationWarning: "Your password changed, but we couldn’t confirm that other devices were signed out. Contact support if you’re concerned about access from another device.",
    recoveryOtherSessionPreserved: "The other account already signed in to this browser remains signed in. Sign out of it first if you want to use the recovered account.",
  ...
  fr: {
    adminQueueBreadcrumb: "Modération",
    adminListingPhotos: "Photos de l’annonce",
    adminListingOpenPhoto: "Ouvrir la photo de l’annonce",
    adminReportContextLimited: "Message signalé et jusqu’à deux messages avant et après celui-ci.",
    adminReportFullConversation: "Examiner la conversation complète",
    adminQueueResults: "résultats",
    adminQueueSearch: "Rechercher",
    adminQueueFilters: "Filtres",
    adminQueueFilterDescription: "Choisissez les filtres, puis affichez les résultats.",
    adminQueueShowResults: "Afficher les résultats",
    adminQueueClearFilters: "Effacer les filtres",
    adminQueueCloseFilters: "Fermer les filtres",
    adminQueueReview: "Examiner",
    adminQueueRetry: "Réessayer",
    adminQueueContext: "Contexte et historique",
    adminQueueBack: "Retour à la liste",
    ...
    openingMarketplace: "Ouverture du marché…",
    continueToMarketplace: "Continuer vers le marché",
    signInUnavailable: "La connexion est momentanément impossible. Veuillez réessayer.",
    authLinkInvalid: "Ce lien de connexion est invalide ou expiré. Connectez-vous ci-dessous ou demandez un nouvel e-mail.",
    ...
    adminAnnouncementWorkerConfigured: "Service d’envoi configuré",
    adminAnnouncementWorkerNeedsScheduler: "Envoi automatique non configuré",
    adminAnnouncementRunWorker: "Traiter les envois en attente",
    adminAnnouncementWorkerDescription:
      "L’envoi automatique reste à configurer. Ce bouton traite les envois en attente par lots. Pour les communiqués planifiés, lancez le traitement après l’heure prévue.",
    ...
    adminAnnouncementCategory_general: "Général",
    adminAnnouncementCategory_maintenance: "Maintenance",
    adminAnnouncementCategory_safety: "Sécurité",
    adminAnnouncementCategory_policy: "Règlement",
    adminAnnouncementCategory_moderation: "Modération",
    adminAnnouncementPriority: "Priorité",
    adminAnnouncementPriority_low: "Faible",
    adminAnnouncementPriority_normal: "Normale",
    adminAnnouncementPriority_high: "Élevée",
    adminAnnouncementPriority_urgent: "Urgente",
    adminAnnouncementAudience: "Public",
    adminAnnouncementAudience_all: "Tout le monde",
    adminAnnouncementAudience_school: "Établissements précis",
    adminAnnouncementAudience_role: "Par rôle",
    adminAnnouncementAudience_selected: "Comptes sélectionnés",
    adminAnnouncementRole_member: "Membres",
    adminAnnouncementRole_staff: "Personnel",
    adminAnnouncementRole_moderator: "Modérateurs",
    adminAnnouncementRole_admin: "Administrateurs",
    ...
    adminAnnouncementSearchCompact: "Rechercher",
    ...
    preparingResetSession: "Vérification du lien de réinitialisation…",
    sendingResetLink: "Envoi du lien de réinitialisation…",
    updatingPassword: "Mise à jour du mot de passe…",
    recoveryForAccount: "Réinitialisation du mot de passe de",
    recoverySessionNotice: "Seul le mot de passe de ce compte sera modifié. Tout autre compte connecté restera connecté. Gardez cette page ouverte jusqu’à la fin.",
    recoveryPasswordPolicy: "Utilisez au moins 8 caractères. Les exigences supplémentaires de votre compte s’appliquent aussi.",
    recoveryLinkInvalid: "Ce lien a expiré, a déjà été utilisé ou a été demandé dans un autre navigateur. Demandez un nouvel e-mail ici et ouvrez-le dans ce navigateur.",
    recoveryPasswordRejected: "Le mot de passe n’a pas été accepté. Demandez un nouvel e-mail et choisissez un autre mot de passe conforme aux exigences de votre compte.",
    recoveryUnavailable: "La réinitialisation est momentanément indisponible. Veuillez réessayer dans un instant.",
    recoveryOutcomeUnknown: "Nous n’avons pas pu confirmer le résultat. Essayez de vous connecter avec le nouveau mot de passe. En cas d’échec, demandez un nouvel e-mail.",
    recoveryCompleteTitle: "Mot de passe mis à jour",
    recoveryComplete: "Votre nouveau mot de passe est prêt. Vous pouvez maintenant l’utiliser pour vous connecter.",
    recoveryRevocationWarning: "Votre mot de passe a changé, mais la déconnexion des autres appareils n’a pas pu être confirmée. Contactez l’assistance si l’accès depuis un autre appareil vous inquiète.",
    recoveryOtherSessionPreserved: "L’autre compte déjà connecté à ce navigateur reste connecté. Déconnectez-vous d’abord pour utiliser le compte récupéré.",
